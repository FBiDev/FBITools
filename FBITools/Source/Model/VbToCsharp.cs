...
namespace FBITools
{
    public static class VbToCsharp
    {
        ...
        static string RemoveHandles(string vbNetCode)
        {
        ...
        static string IIfEquals(string vbNetCode)
        {
        ...
        static string IfEquals(string vbNetCode)
        {
            var patternIf = @"\bif\((.*)\)\{";
            var patternIfContent = @"\s*(?<![=!><])=(?![=><])\s*";
            var replaceIfContent = @" == ";
        ...
        static string ConvertVBNetToCSharp(string vbNetCode)
        {
            //Comments '
            ...
            vbNetCode = Regex.Replace(vbNetCode, pattern, delegate (Match match)
            {
