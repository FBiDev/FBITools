...
namespace FBITools
{
    public partial class WebCrawlerForm : ContentBaseForm
    {
        ...
        private async void CrawButton_Click(object sender, EventArgs e)
        {
            ...
            var folderTitle = URLComboBox.SelectedText.Replace("NoIntro - ", "");
        ...
        private void WgetURLButton_Click(object sender, EventArgs e)
        {
            ...
            const string temp = "https://myrient.erista.me/dats/Lost%20Level/Archive/";
        ...
        {
            if (ResultGrid.Columns[e.ColumnIndex].Name != "FileSize" || !(e.Value is long)) return;
